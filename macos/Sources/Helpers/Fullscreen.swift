...
extension Notification.Name {
    static let fullscreenDidEnter = Notification.Name("com.czaku.fullscreenDidEnter")
    static let fullscreenDidExit = Notification.Name("com.czaku.fullscreenDidExit")
}
