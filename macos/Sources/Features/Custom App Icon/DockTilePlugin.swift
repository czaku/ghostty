...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.czaku.ghostty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.czaku.ghostty")
    #endif
